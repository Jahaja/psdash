...
class TestNode(unittest2.TestCase):
    ...
    @unittest2.skipIf(
        "TRAVIS" in os.environ, "Functionality not supported on Travis CI"
    )
    ...
    @unittest2.skipIf(
        os.environ.get("USER") != "root", "os.setuid requires privileged user"
    )
    ...
    def test_get_process(self):
        ...
        asserts = [
            ...
            "num_children",
            "cwd",
            "num_ctx_switches_invol",
            "num_ctx_switches_vol",
            "cpu_times_user",
            "cpu_times_system",
            "cpu_affinity",
            "cpu_percent",
